...
You can also make a huge contribution by getting involved by leaving review comments on [PRs](https://github.com/Tuhura-Tech/wiki/pulls), adding ideas in existing GitHub [Issues](https://github.com/Tuhura-Tech/wiki/issues) and [Discussions](https://github.com/Tuhura-Tech/wiki/discussions) and participating in our "Pinned" issue maintenance tasks!
...
- **Look at our Existing Issues** (especially those labelled [`help wanted`](https://github.com/Tuhura-Tech/wiki/issues?q=is:open+is:issue+label:%22help+wanted%22) and [`good first issue`](https://github.com/Tuhura-Tech/wiki/issues?q=is:open+is:issue+label:%22good+first+issue%22)) for contributions we are actively seeking.
...
If you're unsure which type of contribution best represents your concern, please [make a new issue](https://github.com/Tuhura-Tech/wiki/issues/new)!
...
> Need help making a PR? [Join us on Discord](https://discord.gg/PNxh7cwKfQ), we'll be more than glad to help you out!
...
Every page on [wiki.tuhuratech.org.nz](https://wiki.tuhuratech.org.nz/) has an **Edit this page** button in the sidebar. You can click that button to edit the source code for that page in **GitHub**.
...
You can find more information about submitting your pull requests in our [contributor guides](https://wiki.tuhuratech.org.nz/tuhura-tech/contribute/)
...
Note that CodeSandbox and StackBlitz provide Astro syntax highlighting in their custom code editors, while Gitpod and Codeflow support the full [Astro VSCode extension](https://wiki.tuhuratech.org.nz/en/editor-setup/#vs-code).
...
```shell
git clone git@github.com:Tuhura-Tech/wiki.git
```
...
```shell
git remote add upstream git@github.com:Tuhura-Tech/wiki.git
```
...
Every pull request generates a preview of the docs site, including your proposed changes, using **Cloudflare** for anyone to see.
...
When you first create your fork, it will be an exact copy of this repository. Over time, `Tuhura-Tech/wiki` will change as the docs are updated, but your fork won’t automatically stay up-to-date. Here are some ways to keep your fork in sync with this repo.
...
- [Read the docs](https://wiki.tuhuratech.org.nz/)
- [Fork the docs](https://github.com/Tuhura-Tech/wiki/fork)
- [Raise an issue](https://github.com/Tuhura-Tech/wiki/issues/new)
- [Discuss the docs](https://discord.gg/PNxh7cwKfQ)
- [Visit the Astro Docs Docs to see even more documentation about contributing to Astro docs!](https://wiki.tuhuratech.org.nz/tuhura-tech/contribute/)

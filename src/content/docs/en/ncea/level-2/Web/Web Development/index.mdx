...
:::note[GET vs POST]
You'll notice that all of the functions that directly interact with our FastAPI app are either **get** or **post.**
An easy way to think of these, is that we use **Get** to get information, wheras a **Post** is used to modify/send/update information.
:::

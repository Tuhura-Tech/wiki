...
Now if you run our app with

```sh
fastapi dev
```

And click the **Documentation at:** Link we'll be taken to the autogenerated docs for our application! This is a great way to see wwhat's happening with our application,
and interact with it, without needing to have everything hooked up to a frontend.

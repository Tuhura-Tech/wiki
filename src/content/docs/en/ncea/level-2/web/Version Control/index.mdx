...
5. Just to practice making a commit, make some changes to your project in VScode, it can be anything, you can even delete them later. Use Ctrl + S to save your changes.

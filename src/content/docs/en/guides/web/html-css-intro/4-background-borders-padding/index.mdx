...
```css
img { /* You can apply this to any element, not just img! */
    border-style: solid;
    border-width: 4px;
    border-color: blue;
    border-radius: 5px;
...
`padding` is a very versatile property and helpful in many different situations. It adds blank space around an element. You can also use percentages instead of pixels, which can help make your website look consistent across different screen sizes.
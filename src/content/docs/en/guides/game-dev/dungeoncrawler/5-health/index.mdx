...
3. First, we'll get a reference to our new **UI** scene. Put this with the other variable declarations. Thankfully, because it's an autoload, this is really easy!

...
This is a tutorial for a basic 2D racing game in Godot. This will follow on from previous learning we did in the [2D Platformer](/game-dev/godot/2dplatformergame). We will be starting with a new project.

...
This is a guide to making a 3-dimensional game in [Godot](https://godotengine.org/). If you are unfamiliar with Godot, check out the [Godot basics](/game-dev/godot/basics) doc and the [3D fundmentals](/game-dev/godot/3d) doc.

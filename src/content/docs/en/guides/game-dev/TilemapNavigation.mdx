...
If you are confused at any point, all of the skills required to complete this guide are covered in the **Dungeon Crawler** Tutorial.
...
Giving us a final script that, at its most basic form, looks like this:

...
If you are confused at any point, all of the skills required to complete this guide are covered in the [**Dungeon Crawler** Tutorial.](/game-dev/godot/)
...
Collision can be added under the **Tileset** Tab at the bottom of the screen, using the **Paint** option.
...
Congratulations! You've added pathfinding to your enemies! If they don't work, make sure your groups are set up correctly (That the player is assigned to a group called "player")

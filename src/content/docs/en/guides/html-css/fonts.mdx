...
There are 5 generic font families available by default in CSS that you can use as the value, some of which are listed below. Experiment with them and see how they look on your website.
...
To use a Google font in your website via link, find the font you would like to use and click Get font. Then click Get embed code and copy the provided code into your HTML and CSS files, making sure to follow the instructions. Make sure you change the font-family name to the font-family name provided in the CSS class.

...
Ready to master databases? Follow these fun, interactive lessons:

1. **[Try SQL Online!](./online-editor/)** - Start writing SQL in your browser - no installation needed!
2. **[Basics](./basics/)** - Learn the basic SQL syntax and commands
3. **[SELECT Queries](./select-queries/)** - Ask the database for exactly what you want!
4. **[Filtering Data](./filtering-data/)** - Use WHERE, AND, OR to find specific data
5. **[Sorting & Limiting](./sorting-limiting/)** - Organize results and show top items
6. **[Counting & Math Functions](./aggregate-functions/)** - COUNT, SUM, AVG, MAX, MIN
7. **[Grouping Data](./grouping-data/)** - Use GROUP BY and HAVING like a pro!
8. **[Tables](./tables/)** - Working with multiple tables and relationships
9. **[Database Design](./design/)** - Best practices for designing databases

:::tip[Start Here!]
New to SQL? Begin with **[Try SQL Online!](./online-editor/)** to start coding immediately without any setup. Then work through the lessons in order for the best learning experience!
:::

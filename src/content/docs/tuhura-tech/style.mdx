...
We've covered all the things you can add to your contribution, but what about writing the content itself? Unfortunately, this is a hard thing to define with strict rules and examples!
But, our focus is to engage and teach those who come to the wiki looking to learn! 

One of the best approaches to writing this kind of material is the [Diátaxis approach](https://diataxis.fr/) which we highly reccomend you take the time to read! 
...
However you'll also find **Reference** style pages on the wiki (Such as the page on [Classes and object oriented programming](../../python/classes)) Which contain direct, clear and referancable information about a particular topic. 

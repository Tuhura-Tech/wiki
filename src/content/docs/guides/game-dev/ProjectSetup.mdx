...
This is a guide to setting up [Godot](https://godotengine.org/) to be used with C# instead of GDScript. If you are unfamiliar with Godot, check out the [Godot basics](/game-dev/godot/basics) doc.

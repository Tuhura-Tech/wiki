...
This is a game. What you have made is a game. It might not look like it, but that's just because you haven't made the art yet.
If you made some high level 3D models of platforms, a button, a character, and added a skybox it would look like a real game. That's truly the only difference.
...
Plan out a small game. Don't plan out the next Skyrim, plan out a small game that you can make in a day, then a game you can make in a week, then a month, and eventually create your masterpiece or show a game company your game portfolio and help make someone else's masterpiece. [Here is a list of New Zealand game developers](https://www.gamedevmap.com/index.php?country=New%20Zealand)
...
Just keep in mind there's nothing stopping you from doing anything. Just because you haven't made a top-down game, modelled terrain, or made a 2.5D game doesn't mean you can't learn how to in the short span of a game jam.

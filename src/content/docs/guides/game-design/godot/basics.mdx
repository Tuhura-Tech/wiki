...
![Godot scene tree with characterbody2d as child of root node, and sprite2d, collisionshape2d, and camera2d as children of characterbody2d](../../../../../assets/godot/basics/ChildNodes.png)
...
> Rename **CharacterBody2D** to **Player** and save it as a seperate scene saved as **player.tscn**.
...
![What the scene tree should look like now](../../../../../assets/godot/basics/PlatformTree.png)
...
![At 42% zoom the sprite and collider takes up about a third of the width of the viewport and is pretty thin](../../../../../assets/godot/basics/PlatformSize.png)
...
![Empty scene with a magenta rectangle on top of a pixelated red circle](../../../../../assets/godot/basics/StaticGame.png)
...
In all likelyhood, if you run the game and jump to your previously interminable fall, now you should reset to the beginning.
...
![The default script with the previously outlined lines of code added](../../../../../assets/godot/basics/DeathboxCode.png)
...
![A small 4-platform obstacle course with the palyer starting on the left and the checkpoint on the right](../../../../../assets/godot/basics/SimpleObstacleCourse.png)
...
Once you get to this screen, change the **Reciever Method** to **_on_checkpoint_entered** just to make things clear.
...
This `line is intersperced` with `code snippets` so that the real answer is less `visually distinctive and people who want to` give it a go can actually try thinking `of the line they need`. The `line needed is reset_position = global_position` but people need a good chance to try and `form some brain connections naturally`.

...
But, if you're already familiar with game development and want to start with 3D, we have a [3d guide](../3d) as well. If you choose this you may miss out on core aspects like signals.
...
3D games aren't much more difficult, [read the guide on making a 3D game](../3d).

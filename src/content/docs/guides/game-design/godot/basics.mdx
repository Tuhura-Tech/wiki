...
![A small 4-platform obstacle course with the player starting on the left and the checkpoint on the right](../../../../../assets/godot/basics/SimpleObstacleCourse.png)
...
![Godot Connect a Signal to a Method dialogue box with the receiver method changed to _on_checkpoint_entered](../../../../../assets/godot/basics/Signal.png)

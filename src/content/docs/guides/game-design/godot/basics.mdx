...
![Godot project manager](../../../../../assets/godot/ProjectManager.png)
...
![New project window](../../../../../assets/godot/NewProject.png)
...
![Empty Godot project](../../../../../assets/godot/EmptyEngine.png)
...
![Empty scene with Node2D as scene route](../../../../../assets/godot/BaseProject.png)
...
![Drop-down of shape property on CollisionShape2D node highlighting New CircleShape2D](../../../../../assets/godot/CircleShape.png)
...
![Cute pixel art circular sprite](../../../../../assets/godot/LilBirdie.png)
...
![Scene with tiny texture in the viewport](../../../../../assets/godot/UpdatedScene.png)
...
![Godot warning no main scene has been selected](../../../../../assets/godot/WarningUndefinedMain.png)
...
![Godot window for making a new script on a CharacterBody2D node](../../../../../assets/godot/NewScript.png)
...
![Godot scripts screen with default CharacterBody2D template loaded on a GDScript called player.gd](../../../../../assets/godot/Script.png)
...
![Pixel art of a platform](../../../../../assets/godot/Platform.png)

When running, your game should now look something like this:
![A nearly blank game window with a platform pixel art sprite with a platform below it.](../../../../../assets/godot/NearEmptyGame.png)

...
Let's start with just clearing some things up so you know what's possible first. Each tool has a hundred different uses for specific scenarios, and it's unlikely you'll need the vast majority of available options.
...
![Blender's Layout workspace image](/src/assets/blender/navigating/LayoutWorkspace.png)

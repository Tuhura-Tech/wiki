...
![Four verticies selected for deletion](/src/assets/blender/modifiers/DeleteHalf.png)
...
You can turn the modifier's visiblity with this button at the top-right of the modifier:

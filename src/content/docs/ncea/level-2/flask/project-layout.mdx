...
This follows the basic structure that most Flask projects follow. It can work with different layouts (eg. one file) but this is not recommended. Follow [Python Setup](/guides/python/setting-up) guide to get your project ready with everything installed. You will also need to install flask follow the dependency instructions.

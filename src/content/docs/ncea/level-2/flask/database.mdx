...
Creation and management of our database will be done in SQL which allows us to easily recreate and change our database whenever we want. The [SQL tutorial](../../../../sql/sql.mdx) can offer a good deep dive into the syntax.

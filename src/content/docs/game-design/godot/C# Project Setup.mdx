...
**This Guide will cover setting up Godot to be used with C#, but not C# deveiopment. To learn more about C# Development with Godot, consult the [Godot C# Docs](https://docs.godotengine.org/en/stable/tutorials/scripting/c_sharp/index.html)
:::note[Version]
...
you'll now notice that your C# Scripts open in visual studio. Perfect!

:::note[Mix and Match]
While you've set up your project to work with C#, you can still us GDScript! You can even mix and match the two within a project if you wish.
:::

The other **Important** thing to note, is that each time you've made changes to your code you want to test, make sure you **Save** with ctrl + s. As well as **Build** the code within Godot. This can be done easily using the hammer button in the top right.

...
Finally, set the shape of the **CollisionShape2D** child of the **Area2D** to be a circle, making it however large you want the 'detection' range of the enemy to be!

### Enemy Scripting

### Destroying the enemy!
sword scene function
## Another floor

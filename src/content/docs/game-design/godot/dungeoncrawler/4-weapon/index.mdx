...
1. Create a new scene for our weapon!
	Give it a Root node of a **Node2D** and name it something like "Weapon"  
...
### Weapon Script
<Steps>
1. Let's create a script to control our weapon, create it using the default template and attach it to the **root node2d,** call it something like "weapon"

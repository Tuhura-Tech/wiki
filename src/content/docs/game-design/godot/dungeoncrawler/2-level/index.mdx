...
<Steps>
1. Create a new scene. Give it a node2D as its root node, and call it something like "World" 

    Save the scene in our Scenes folder, calling it something like "world.tscn".

2. Give our root node a child of type **Node2D** and call it something like "level"

...
1. If our health is set to 0, show the "You died text" Otherwise, If the health recieved is bigger than our highest health so far, make that our new highest health. Easy enough!

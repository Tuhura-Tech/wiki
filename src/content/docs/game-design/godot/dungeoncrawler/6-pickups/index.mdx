...
1. For coins, we'll create a new scene with a root node of **Staticbody2D** calling it something like "Coin"
...
1. Let's head to our UI Scene. To the root node, add a new child, of type **HBoxContainer** call it something like "pointContainer"

2. Give it two children, a **TextureRect** and a **Label,** name the label something like **pointsLabel** 

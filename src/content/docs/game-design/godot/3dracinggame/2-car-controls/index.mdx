...
This is what your file structure should look like. Rename the nodes to simpler terms, e.g. VehicleBody3D -> "Car".


![File structure for a car, camera, light and ground](/src/assets/godot/3DRacing/builtCarFileStructure.png)

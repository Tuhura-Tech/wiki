...
1. In the Inspector:
    ...
    - Under **Wheel** change the **Roll Influence** to 1.0 (to keep the car from flipping over) **Radius** to 0.4m and **Friction Slip** to 2 (1 is normal grip, higher means more grip).
